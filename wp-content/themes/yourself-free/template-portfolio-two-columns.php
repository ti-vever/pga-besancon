...
<div id="content" class="clearfix">
	...
	<div id="portfolio-content" class="clearfix">
		...
		<!-- BEGIN #columns-wrap .two-columns -->
		...
		<?php if ($query->have_posts()) : while ($query->have_posts()) : $query->the_post(); ?>
			...
			<li data-id="id-<?php echo $count; ?>" data-type="<?php if(!empty($terms)){ foreach ($terms as $term) { echo strtolower(preg_replace('/\s+/', '-', $term->name)). ' '; } } ?>" class="project clearfix">
				<!-- BEGIN .post -->
